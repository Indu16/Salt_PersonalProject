...
* The original package name 'personal.project.jfs.inventory.spring-boot' is invalid and this project uses 'personal.project.jfs.inventory.springboot' instead.
